...
<div class="formReservas py-1 py-lg-2 px-4">
					...
					<div class="form-group my-4">
						<select class="form-control form-control-lg selectTemaHabitacion" name="id_habitacion" required  >
		...
		<input type="hidden" id="ruta" name="ruta" >
					...
					<div class="row">
						 ...
						 <div class="col-6 input-group input-group-lg pr-1">
							...
							<input type="text" class="form-control datepicker entrada"  name="fecha_ingreso" required placeholder="Entrada">
						...
						<div class="col-6 input-group input-group-lg pl-1">
							...
							<input type="text" class="form-control datepicker salida" name="fecha_salida" placeholder="Salida" required>
						...
						<a href="<?php echo $ruta.'perfil'; ?>">  
							...
							<?php else: ?>
									...
									<?php if ($usuario["modo"] == "direccto"): ?>
										...
										<img src="<?php echo $servidor.$usuario["foto"]; ?>" class="img-fluid rounded-circle" style="width:50px">
									<?php else : ?>	

									
										<img src="<?php echo $usuario ["foto"]  ?>" style="width:50px" alt="">
